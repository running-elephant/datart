      ...
      rows: [
        ...
        },
        {
          ...
          options: {
            translateItemLabel: true,
            items: [
              { label: 'visualMap.alignAuto', value: 'auto' },
              { label: 'visualMap.alignRight', value: 'right' },
              { label: 'visualMap.alignTop', value: 'top' },
              { label: 'visualMap.alignBottom', value: 'bottom' },
              { label: 'visualMap.alignLeft', value: 'left' },
            ],
          },
        },
        {
