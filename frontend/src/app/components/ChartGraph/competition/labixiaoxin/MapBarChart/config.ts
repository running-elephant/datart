/*
 * @Author: minsion
 * @Date: 2022-03-01 10:58:43
 * @LastEditTime: 2022-03-19 15:16:48
 * @Description: MapBarChart
 */
  ...
  styles: [
      ...
      rows: [
        {
          ...
          default: 'henan',
          options: {
            items: [{ label: '河南', value: 'henan' }],
          },
        },
        {
          label: 'mapBar.enableZoom',
          key: 'enableZoom',
          default: true,
          comType: 'checkbox',
        },
        {
          label: 'mapBar.areaColor',
          key: 'areaColor',
          default: '#297ffa',
          comType: 'fontColor',
        },
        {
          label: 'mapBar.focusArea',
          key: 'focusArea',
          default: true,
          comType: 'checkbox',
        },
        {
          label: 'mapBar.areaEmphasisColor',
          key: 'areaEmphasisColor',
          default: '#4aacf0',
          comType: 'fontColor',
        },
        {
          label: 'mapBar.borderStyle',
          key: 'borderStyle',
          comType: 'line',
          default: {
            type: 'dashed',
    ...
    },
    {
      ...
      rows: [
        ...
        {
          label: 'viz.palette.style.visualMap.startColor',
          key: 'startColor',
          default: '#4aacf0',
          comType: 'fontColor',
        },
        {
          label: 'viz.palette.style.visualMap.endColor',
          key: 'endColor',
          default: '#4aacf0',
          comType: 'fontColor',
        },
        {
          label: 'viz.palette.style.visualMap.barSize',
          key: 'barSize',
          default: 2,
          comType: 'inputNumber',
        },
        {
          label: 'viz.palette.style.visualMap.bevelSize',
          key: 'bevelSize',
          default: 0.3,
          comType: 'inputNumber',
        },
