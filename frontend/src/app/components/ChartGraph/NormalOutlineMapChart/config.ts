      ...
      rows: [
        {
          ...
          options: {
            ...
            items: [
              { label: '@global@.levelType.australia', value: 'australia' },
              { label: '@global@.levelType.bhutan', value: 'bhutan' },
              { label: '@global@.levelType.canada', value: 'canada' },
              { label: '@global@.levelType.china', value: 'china' },
              { label: '@global@.levelType.chinaCity', value: 'china-city' },
              { label: '@global@.levelType.chinaEng', value: 'china-eng' },
              { label: '@global@.levelType.india', value: 'india' },
              { label: '@global@.levelType.indonesia', value: 'indonesia' },
              { label: '@global@.levelType.malaysia', value: 'malaysia' },
              { label: '@global@.levelType.myanmar', value: 'myanmar' },
              { label: '@global@.levelType.newZealand', value: 'newZealand' },
              { label: '@global@.levelType.philippines', value: 'philippines' },
              { label: '@global@.levelType.singapore', value: 'singapore' },
              { label: '@global@.levelType.southKorea', value: 'southKorea' },
              { label: '@global@.levelType.sriLanka', value: 'sriLanka' },
              { label: '@global@.levelType.thailand', value: 'thailand' },
              { label: '@global@.levelType.unitedStates', value: 'unitedStates' },
              { label: '@global@.levelType.vietnam', value: 'vietnam' },
            ],
          },
        },
        {
