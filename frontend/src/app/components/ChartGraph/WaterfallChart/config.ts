      ...
      rows: [
        ...
        },
        {
          ...
          options: {
            translateItemLabel: true,
            items: [
              { label: 'common.positionTop', value: 'top' },
              { label: 'common.positionLeft', value: 'left' },
              { label: 'common.positionRight', value: 'right' },
              { label: 'common.positionBottom', value: 'bottom' },
              { label: 'common.positionInside', value: 'inside' },
              { label: 'common.positionInsideLeft', value: 'insideLeft' },
              { label: 'common.positionInsideRight', value: 'insideRight' },
              { label: 'common.positionInsideTop', value: 'insideTop' },
              { label: 'common.positionInsideBottom', value: 'insideBottom' },
              { label: 'common.positionInsideTopLeft', value: 'insideTopLeft' },
              { label: 'common.positionInsideBottomLeft', value: 'insideBottomLeft' },
              { label: 'common.positionInsideTopRight', value: 'insideTopRight' },
              { label: 'common.positionInsideBottomRight', value: 'insideBottomRight' },
            ],
          },
        },
        {
