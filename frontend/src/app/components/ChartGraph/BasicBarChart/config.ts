      ...
      rows: [
        ...
        },
        {
          ...
          options: {
            translateItemLabel: true,
            items: [
              { label: 'legend.typePlain', value: 'plain' },
              { label: 'legend.typeScroll', value: 'scroll' },
            ],
          },
        },
        {
      ...
      rows: [
        ...
        },
        {
          ...
          options: {
            translateItemLabel: true,
            items: [
              { label: 'common.nameLocationStart', value: 'start' },
              { label: 'common.nameLocationEnd', value: 'end' },
              { label: 'common.nameLocationCenter', value: 'center' },
            ],
          },
        },
        {
  ...
  i18ns: [
    {
      ...
      translation: {
        common: {
          ...
          nameLocation: '标题位置',
          nameLocationStart: '开始',
          nameLocationEnd: '结束',
          nameLocationCenter: '中间',
          nameRotate: '标题旋转',
          nameGap: '标题与轴线距离',
          min: '最小值',
          max: '最大值',
    ...
    },
    {
      ...
      translation: {
        common: {
          ...
          nameLocationStart: 'Start',
          nameLocationEnd: 'End',
          nameLocationCenter: 'Center',
